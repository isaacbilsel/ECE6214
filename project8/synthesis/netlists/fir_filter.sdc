...
# Created by write_sdc on Thu Apr 24 19:57:18 2025
...
set_load -pin_load 0.2 [get_ports {fir_out[11]}]
set_load -pin_load 0.2 [get_ports {fir_out[10]}]
set_load -pin_load 0.2 [get_ports {fir_out[9]}]
set_load -pin_load 0.2 [get_ports {fir_out[8]}]
set_load -pin_load 0.2 [get_ports {fir_out[7]}]
set_load -pin_load 0.2 [get_ports {fir_out[6]}]
set_load -pin_load 0.2 [get_ports {fir_out[5]}]
set_load -pin_load 0.2 [get_ports {fir_out[4]}]
set_load -pin_load 0.2 [get_ports {fir_out[3]}]
set_load -pin_load 0.2 [get_ports {fir_out[2]}]
set_load -pin_load 0.2 [get_ports {fir_out[1]}]
set_load -pin_load 0.2 [get_ports {fir_out[0]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[7]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[6]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[5]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[4]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[3]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[2]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[1]}]
set_load -pin_load 0.2 [get_ports {coeff_read_out[0]}]
...
set_max_fanout 1 [get_ports coeff_read]
...
set_max_fanout 1 [get_ports {coeff_addr[9]}]
set_max_fanout 1 [get_ports {coeff_addr[8]}]
set_max_fanout 1 [get_ports {coeff_addr[7]}]
...
set_input_delay -clock v_clk  3  [get_ports coeff_read]
...
set_input_delay -clock v_clk  3  [get_ports {coeff_addr[9]}]
set_input_delay -clock v_clk  3  [get_ports {coeff_addr[8]}]
set_input_delay -clock v_clk  3  [get_ports {coeff_addr[7]}]
...
set_output_delay -clock v_clk  3  [get_ports {fir_out[11]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[10]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[9]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[8]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[7]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[6]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[5]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[4]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[3]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[2]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[1]}]
set_output_delay -clock v_clk  3  [get_ports {fir_out[0]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[7]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[6]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[5]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[4]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[3]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[2]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[1]}]
set_output_delay -clock v_clk  3  [get_ports {coeff_read_out[0]}]
...
set_input_transition -max -rise 0.1  [get_ports coeff_read]
set_input_transition -max -fall 0.12  [get_ports coeff_read]
set_input_transition -min -rise 0.1  [get_ports coeff_read]
set_input_transition -min -fall 0.12  [get_ports coeff_read]
...
set_input_transition -max -rise 0.1  [get_ports {coeff_addr[9]}]
set_input_transition -max -fall 0.12  [get_ports {coeff_addr[9]}]
set_input_transition -min -rise 0.1  [get_ports {coeff_addr[9]}]
set_input_transition -min -fall 0.12  [get_ports {coeff_addr[9]}]
set_input_transition -max -rise 0.1  [get_ports {coeff_addr[8]}]
set_input_transition -max -fall 0.12  [get_ports {coeff_addr[8]}]
set_input_transition -min -rise 0.1  [get_ports {coeff_addr[8]}]
set_input_transition -min -fall 0.12  [get_ports {coeff_addr[8]}]
set_input_transition -max -rise 0.1  [get_ports {coeff_addr[7]}]
set_input_transition -max -fall 0.12  [get_ports {coeff_addr[7]}]
set_input_transition -min -rise 0.1  [get_ports {coeff_addr[7]}]
set_input_transition -min -fall 0.12  [get_ports {coeff_addr[7]}]
