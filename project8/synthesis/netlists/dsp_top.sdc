...
# Created by write_sdc on Sat Apr 12 23:02:05 2025
...
set_max_fanout 1 [get_ports coeff_rw]
...
set_input_delay -clock v_clk  3  [get_ports coeff_rw]
...
set_input_transition -max -rise 0.1  [get_ports coeff_rw]
set_input_transition -max -fall 0.12  [get_ports coeff_rw]
set_input_transition -min -rise 0.1  [get_ports coeff_rw]
set_input_transition -min -fall 0.12  [get_ports coeff_rw]
